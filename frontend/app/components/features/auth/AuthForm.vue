  ...
  <div class="relative w-full max-w-md mx-auto my-4">
    <div class="w-full relative z-0">
      ...
      <form @submit.prevent="submit" class="space-y-3">
        <!-- Name Grid -->
        <div v-if="fields.includes('first_name') && fields.includes('last_name')" class="grid grid-cols-2 gap-3">
        ...
        <!-- Other Fields -->
        <div v-for="field in fields.filter(f => !['first_name', 'last_name'].includes(f))" :key="field" class="relative">
          <i
            :class="
              icons[field] +
