  ...
  <div class="terms-page">
    ...
    <div class="content-wrapper p-4 sm:p-6">
      ...
      <div class="mb-6">
        <div class="flex items-center justify-between">
          ...
          <nav class="flex items-center gap-2 text-sm text-gray-500 mb-4" aria-label="Breadcrumb">
            ...
            <i class="bx bx-chevron-right text-gray-400 text-base"></i>
            <span class="text-[#10b481] font-medium">Conditions d'utilisation</span>
          </nav>
        </div>
      </div>
      ...
      <div class="hero-banner">
        ...
        <div class="hero-text">
          <h1 class="hero-title">{{ t("terms") }}</h1>
          <p class="hero-date">
          ...
          <div class="toc-card">
            ...
            <nav class="toc-list">
              ...
              >
                ...
                <span class="toc-label" v-html="t(`terms${i}Title`)"></span>
        ...
        <div class="sections-wrapper">
          ...
          >
            <div class="section-header">
              ...
              <h2 class="section-title" v-html="t(`terms${i}Title`)"></h2>
            </div>
            <div class="section-divider"></div>
            <p class="section-text" v-html="t(`terms${i}Text`)"></p>
          </section>
    ...
    (entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const num = parseInt(id.replace("term-", ""));
...
.bg-mesh {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse 70% 50% at 10% -5%, rgba(16,180,129,0.07) 0%, transparent 55%),
    radial-gradient(ellipse 50% 40% at 95% 100%, rgba(16,180,129,0.05) 0%, transparent 55%);
  pointer-events: none;
  z-index: 0;
}
...
.terms-section { background: white; border-radius: 20px; border: 1px solid #f1f5f9; padding: 2rem; scroll-margin-top: 100px; }
.terms-section:hover { border-color: #10b481; box-shadow: 0 10px 30px rgba(0,0,0,0.03); }
...
.section-title { font-size: 1.15rem; font-weight: 800; color: #111827; margin-bottom: 1.5rem; }
