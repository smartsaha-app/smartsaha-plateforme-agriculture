# Generated by Django 5.2.8 on 2026-03-22 20:02

from django.db import migrations

def seed(apps, schema_editor):
    Variety = apps.get_model("crops", "Variety")
    varieties = [
    ...
    for v in varieties:
        Variety.objects.get_or_create(name=v["name"], defaults={"description": v["description"]})
